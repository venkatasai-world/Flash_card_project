...
try:
    data = pd.read_csv(r"day31\data\words_to_learn.csv")
...
card_front_img=PhotoImage(file=r"day31\images\card_front.png")
card_back_img=PhotoImage(file=r'day31\images\card_back.png')
...
cross_image=PhotoImage(file=r"day31\images\wrong.png")
unknown_button=Button(image=cross_image,highlightthickness=0,command=next_card)
unknown_button.grid(row=1,column=0)

check_image=PhotoImage(file=r"day31\images\right.png")
